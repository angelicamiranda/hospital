                            ...
                            <table class="newtable">
                                ...
                                <tbody>
                                    @foreach ($especialistas as $especialista)
                                                ...
                                                <tr>
                                                    <td>{{($especialista->iddoctor == null)? "--": $especialista->doctor->name}}</td>
                  
                                                 
                                                    <td>{{($especialista->idespecialidad == null)? "--": $especialista->especialidad->nombre}}</td>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <a href="{{route('especialista.edit', $especialista->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        ...
                                                        <form action="{{route('especialista.delete', $especialista->id)}}" method="POST" style="display: inline-block" onsubmit="return confirm('seguro?')">
                                                            @csrf
