...
<html lang="en">
	...
	<body id="kt_body" class="bg-dark">
		...
		<div class="d-flex flex-column flex-root">
            ...
            padding: 0px;
            background: url(img/imgback.jpg) no-repeat center top ;
            background-size: cover;">
				<!--begin::Content-->
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<a href="../../demo1/dist/index.html" class="mb-10">
						<img alt="Logo" src="../../img/clinica.png" class="h-80px" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					...
					<form class="container" method="POST" action="{{ route('login') }}" enctype="multipart/form-data">
                        @csrf
							...
							<div class="text-center">
								<!--begin::Submit button-->
								<button type="submit" id="kt_sign_in_submit" class="btn btn-lg btn-primary w-100 mb-5" style="background-color: #0077b5">
