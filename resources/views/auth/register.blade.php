...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link rel="shortcut icon" href="../demo1/dist/assets/media/logos/favicon.ico" />
		<!--begin::Fonts-->
	...
	<body id="kt_body" class="bg-dark">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(../demo1/dist/assets/media/illustrations/sketchy-1/14-dark.png">
				<!--begin::Content-->
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<a href="../../demo1/dist/index.html" class="mb-12">
						<img alt="Logo" src="../demo1/dist/assets/media/logos/logo-2.svg" class="h-40px" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form method="POST" action="{{ route('register') }}">
							...
							<img alt="Logo" src="../demo1/dist/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Sign in with Google</button>
							<!--end::Action-->
							<!--begin::Separator-->
