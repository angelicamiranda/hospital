    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <br><br><br> 
                <form class="container" method="POST" action="{{ route('especialidad.update', $especialidad->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="text-center mb-10">
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">Editar Especialidad</h1>
                        <!--end::Title-->
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="nombre" value="{{$especialidad->nombre}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Nombre"  />
                                </div>
                                <!--end::Col-->
                            </div>
                            <br>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="descripcion" value="{{$especialidad->descripcion}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Descripcion"  />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
