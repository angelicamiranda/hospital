            ...
            <div class="card mb-5 mb-xl-8">
                <div class="containertable">
                    ...
                    <div class="text-center mb-10">
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">Lista de Pacientes</h1>
                        <!--end::Title-->
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <!--end::Svg Icon-->Añadir Paciente</button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form id="kt_modal_add_user_form" class="form" method="POST"  action="{{ route('users.paciente.store') }}"
                                            ...
                                            @csrf
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        <!--begin::Label-->
                                                        <label class="required fw-bold fs-6 mb-2">Fecha de Nacimiento</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input type="date" name="fechanacimiento" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Consultorio" value="" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                        <!--begin::Label-->
                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                       @if ($user->tipo == 'paciente')
                                                <tr>
                                                    @if (Auth::user()->tipo == 'paciente' && Auth::user()->id == $user->id)
                                                    ...
                                                    <td>{{($user->fechanacimiento == null)? "--": $user->fechanacimiento}}</td>
                                                    <td>
                                                        @if ($user->tipo == 'paciente')
                                                            <span class="badge badge-light-primary fs-7 fw-bold">{{($user->tipo == null)? "--": "Paciente"}}</span>
                                                    
                                                        @endif
                                                    
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="{{route('historial.pdfhistorial', $user->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <a href="{{route('users.paciente.edit', $user->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        ...
                                                        <form action="{{route('users.paciente.delete', $user->id)}}" method="POST" style="display: inline-block" onsubmit="return confirm('seguro?')">
                                                            @csrf
