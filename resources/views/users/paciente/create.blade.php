...
@endif
@section('title')
<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Añadir un nuevo Paciente
@endsection
@section('content')
<style>
            #imagen{
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <br><br><br> 
                <form class="container" method="POST" action="{{ route('users.paciente.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="text-center mb-10">
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">Añadir Paciente</h1>
                        <!--end::Title-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="ci" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Carnet de Identidad"  />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="telefono" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Numero de Celular"  />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="date" name="fechanacimiento" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Fecha de Nacimiento"  />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
