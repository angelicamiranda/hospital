    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <br><br><br> 
                <form class="container" method="POST" action="{{ route('resultado.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="text-center mb-10">
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">Añadir Resultado</h1>
                        <!--end::Title-->
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">{{$analisi->analisi->cita->paciente->name}}</label>
                                  </div>
                                <!--end::Col-->
                            </div>
                            <br>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6"> Doctor :{{$analisi->analisi->cita->especialista->doctor->name}} - Especialidad:{{$analisi->analisi->cita->especialista->especialidad->nombre}} </label>
                                  </div>
                                <!--end::Col-->
                            </div>
                            <br>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="descripcion" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Nombre"  />
                                </div>
                                <!--end::Col-->
                            </div>
                            <br>
                        ...
                        <input type="hidden" name="idanalisis" value="{{$analisi->id}}">
