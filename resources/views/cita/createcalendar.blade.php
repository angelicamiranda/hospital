                                        ...
                                        <form class="form" action="#" id="kt_modal_add_event_form">
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="fv-row mb-9">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <select name="idpaciente" id="select-room" class="form-control form-control-solid" onchange="habilitar()" >
                                                ...
                                                <div class="fv-row mb-9">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-bold mb-2">Doctores</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <select name="idespecialista" id="select-room" class="form-control" onchange="habilitar()" >
                                                        <option value="nulo">Doctores</option>
                                
                                                        @foreach ($especialistas as $especialista)
                                
                                                            <option value="{{$especialista->id}}">
                                
                                                               <spam>Especialidad : {{$especialista->especialidad->nombre}} - Doctor: {{$especialista->user->name}}</spam>
                                                ...
                                                <div class="row row-cols-lg-2 g-10">
                                                    <div class="col">
                                                        <div class="fv-row mb-9">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input class="form-control form-control-solid" name="fecha" placeholder="Pick a start date" id="kt_calendar_datepicker_start_date" />
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row row-cols-lg-2 g-10">
                                                    <div class="col">
                                                        <div class="fv-row mb-9">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input class="form-control form-control-solid" name="fechafin" placeholder="Pick a end date" id="kt_calendar_datepicker_end_date" />
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                    <div class="col" data-kt-calendar="datepicker">
